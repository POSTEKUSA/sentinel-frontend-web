...
export const MOCK_ACCESSORY_MOVEMENTS: AccessoryMovement[] = [
  ...
  { id: 'mov-4', accessoryId: 'acc-1', accessoryType: 'Rollo de papel térmico 57mm', movementType: 'out', quantity: 25, date: daysAgoIso(5), merchantId: 'mer-3', merchantName: 'Restaurante El Portón', executiveId: 'tec-1', executiveName: 'Roberto Mendoza', zone: 'Managua' },
