...
export const MOCK_PURCHASE_ORDERS: PurchaseOrder[] = [
  {
    ...
    deliveryLocation: 'Almacén Central Tegucigalpa', status: 'received', createdBy: 'operador.andrea', createdAt: '2026-05-01T08:00:00.000Z',
  ...
  },
  {
    ...
    deliveryLocation: 'Almacén Central Tegucigalpa', status: 'partially_received', createdBy: 'operador.andrea', createdAt: '2026-06-10T08:00:00.000Z',
    lines: [
  ...
  },
  {
    ...
    deliveryLocation: 'Almacén Regional San Pedro Sula', status: 'in_transit', createdBy: 'operador.jose', createdAt: '2026-06-25T08:00:00.000Z',
    lines: [
  ...
  },
  {
    ...
    deliveryLocation: 'Almacén Central Tegucigalpa', status: 'created', createdBy: 'operador.andrea', createdAt: '2026-07-01T08:00:00.000Z',
    lines: [
  ...
  },
  {
    ...
    deliveryLocation: 'Almacén Central Tegucigalpa', status: 'cancelled', createdBy: 'operador.jose', createdAt: '2026-03-01T08:00:00.000Z',
    lines: [
