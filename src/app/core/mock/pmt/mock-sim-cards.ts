...
export const MOCK_PMT_SIM_CARDS: SimCard[] = [
  { id: 1, inventoryCode: 'SIM-001', iccid: '8950410112340001', numero: '+50430000001', compania: 'Claro', estado: 'instalada', assignedTo: 'mgarcia', terminalSerie: 'VX001242', posInventoryCode: 'POS-009', apn: 'internet.claro.hn', ip: '10.0.0.1', createdAt: '2025-01-10T08:00:00Z', updatedAt: '2025-03-01T08:00:00Z' },
  { id: 2, inventoryCode: 'SIM-002', iccid: '8950410112340002', numero: '+50430000002', compania: 'Tigo', estado: 'instalada', assignedTo: 'rmartinez', terminalSerie: 'VX001243', posInventoryCode: 'POS-010', apn: 'internet.tigo.hn', ip: '10.0.0.2', createdAt: '2025-01-10T08:00:00Z', updatedAt: '2025-03-01T08:00:00Z' },
  { id: 3, inventoryCode: 'SIM-003', iccid: '8950410112340003', numero: '+50430000003', compania: 'Postek', estado: 'instalada', assignedTo: 'mgarcia', terminalSerie: 'VX001244', posInventoryCode: 'POS-011', apn: 'internet.postek.hn', createdAt: '2025-01-15T08:00:00Z', updatedAt: '2025-02-01T08:00:00Z' },
  ...
  { id: 11, inventoryCode: 'SIM-011', iccid: '8950410112340011', numero: '+50430000011', compania: 'Claro', estado: 'instalada', terminalSerie: 'VX001253', posInventoryCode: 'POS-020', apn: 'internet.claro.hn', ip: '10.0.0.3', createdAt: '2025-03-01T08:00:00Z', updatedAt: '2025-04-01T08:00:00Z' },
