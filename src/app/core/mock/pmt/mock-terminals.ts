...
export const MOCK_PMT_TERMINALS: Terminal[] = [
  ...
  { id: 12, serie: 'VX001245', inventario: 'INV-012', modelo: 'Ingenico Move5000', estado: 'instalado', zona: 'Norte', nombre: 'Diunsa Plaza Premier', codigo: 'DIU001', terminal: 'T00004', direccion: 'Bo La Granja 8', ciudad: 'Choloma', comunicacion: 'GPRS', createdAt: '2025-02-01T08:00:00Z', updatedAt: '2025-03-05T08:00:00Z' },
  ...
  { id: 22, serie: 'VX001255', inventario: 'INV-022', modelo: 'Ingenico Move5000', estado: 'asignado_ejecutivo', zona: 'Centro', assignedTo: 'ejecutivo1', assignedAt: '2025-04-01T09:00:00Z', createdAt: '2025-03-10T08:00:00Z', updatedAt: '2025-04-01T09:00:00Z' },
...
export const MOCK_PMT_ASSIGNED_HISTORY: AssignedPosHistory[] = [
  ...
  { id: 7, serie: 'VX001255', modelo: 'Ingenico Move5000', assignedTo: 'ejecutivo1', role: 'ejecutivo', assignedAt: '2025-04-01T09:00:00Z', comment: 'Demo / prueba comercial' },
];
