...
export const MOCK_PMT_TERMINALS: Terminal[] = [
  { id: 1, serie: 'VX001234', inventario: 'POS-001', marca: 'Verifone', modelo: 'VX520', estado: 'en_bodega', warehouseId: 2, zona: 'Norte', caja: 'CAJA-01', inyectado: 'Si', fecha: '2025-01-10', createdAt: '2025-01-10T08:00:00Z', updatedAt: '2025-01-10T08:00:00Z' },
  ...
  { id: 22, serie: 'VX001255', inventario: 'POS-022', marca: 'Ingenico', modelo: 'Move5000', estado: 'asignado_ejecutivo', warehouseId: 1, zona: 'Centro', assignedTo: 'ejecutivo1', assignedAt: '2025-04-01T09:00:00Z', createdAt: '2025-03-10T08:00:00Z', updatedAt: '2025-04-01T09:00:00Z' },
