...
const routes: Routes = [
  ...
  // ── Sistema de administración de POS (Sentinel) ──
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./features/pos-admin/purchase-orders/purchase-order-list.component').then(m => m.PurchaseOrderListComponent),
  },
  {
    path: 'pos-admin/purchase-orders/:id',
    loadComponent: () =>
      import('./features/pos-admin/purchase-orders/purchase-order-form.component').then(m => m.PurchaseOrderFormComponent),
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./features/pos-admin/merchants/merchant-list.component').then(m => m.MerchantListComponent),
  },
  {
    path: 'pos-admin/merchants/:id',
    loadComponent: () =>
      import('./features/pos-admin/merchants/merchant-detail.component').then(m => m.MerchantDetailComponent),
  },
